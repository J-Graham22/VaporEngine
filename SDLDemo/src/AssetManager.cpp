...
void AssetManager::CreateProjectile(Vector2D pos, Vector2D velocity, int range, int speed, std::string id, std::string tag) {
	...
	projectile.addComponent<Collider>(tag);
